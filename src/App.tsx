...
import { languageAtom, counterAtom } from './store/atoms';
...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-br from-background to-muted/50 flex flex-col items-center justify-center p-8">
